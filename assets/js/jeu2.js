...
images.fabric.src = '../assets/img/jeu2/ingredients/fabric.svg';
images.dye.src = '../assets/img/jeu2/ingredients/dye.svg';
images.needle.src = '../assets/img/jeu2/ingredients/needle.svg';
images.scissors.src = '../assets/img/jeu2/ingredients/scissors.svg';
images.river.src = '../assets/img/jeu2/river.svg';
images.beer.src = '../assets/img/jeu2/malus/beer4.svg';
images.gear.src = '../assets/img/jeu2/malus/gear.svg';
images.raft.src = '../assets/img/jeu2/floss-idle-no-sail-transp.png';
images.lehmann.src = '../assets/img/jeu2/lehmann.png';
...
// --- TEXTES CINÉMATIQUE VICTOIRE (FR/EN) ---
const JEU2_VICTORY_TEXTS = {
    fr: [
...
// --- TEXTES CINÉMATIQUE INTRO (FR/EN) ---
const JEU2_INTRO_TEXTS = {
    fr: [
...
const introSteps = [
    {
        ...
        actions: [
            {
                type: 'spawn', id: 'seb', x: 0.2, y: 0.8, sprite: '../assets/img/jeu2/lehmann.png',
...
startBtn.addEventListener('click', () => {
    ...
    backtrack = new Audio('../assets/sound/music/jeu2.mp3');
    backtrack.loop = true;
    backtrack.play();
...
document.getElementById('victoryContinueBtn').addEventListener('click', () => {
    document.getElementById('victoryScreen').style.display = 'none';
    victory = false;
    Cinematic.play(canvas, applyCineTexts(victorySteps, JEU2_VICTORY_TEXTS[getLang()]), () => {
        localStorage.setItem('sebquest_level', '2');
...
// Lancer la cinématique d'intro uniquement en devMode
if (localStorage.getItem('devMode') === 'true') {
    document.getElementById('startScreen').style.display = 'none';
    Cinematic.play(canvas, applyCineTexts(introSteps, JEU2_INTRO_TEXTS[getLang()]), () => {
        document.getElementById('startScreen').style.display = 'flex';
    });
} else {
    document.getElementById('startScreen').style.display = 'flex';
